...
5. In BrawlCrate, navigate to `Tools > Settings > Updater`, click `Manage Subscriptions`, `Add`, and paste this link: `https://github.com/squidgy617/BrawlInstallerPlugins` and hit `Okay`. If you set this up in BrawlCrate, the plugins will update automatically when you launch BrawlCrate.
