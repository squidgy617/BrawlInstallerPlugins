...
def main():
		try: 
			...
			fighterId = showIdPrompt("Enter base fighter ID")
			...
			if cssSlotConfigId:
				...
				BrawlAPI.ShowMessage("Could not find a matching CSS slot ID for this fighter ID. Please try a different fighter ID.", "No match found")
