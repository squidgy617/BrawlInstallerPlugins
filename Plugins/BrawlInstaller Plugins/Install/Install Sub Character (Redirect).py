...
def main():
		try: 
			...
			baseCssSlotConfigId = showIdPrompt("Enter base CSS slot config ID")
			baseCssSlotConfigId = baseCssSlotConfigId.split('0x')[1].upper()
			...
			installCharacter(fighterId=fighterId, baseCssSlotId=baseCssSlotConfigId, cosmeticConfigId=cosmeticConfigId, slotConfigId=slotConfigId, cssSlotConfigId=cssSlotConfigId)
